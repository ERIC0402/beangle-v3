...
import org.beangle.emsapp.security.action.ServiceFlowAction;
import org.beangle.emsapp.security.action.SessioninfoLogAction;
import org.beangle.emsapp.security.action.SubSystemAction;
import org.beangle.emsapp.security.action.UserAction;
import org.beangle.emsapp.security.helper.UserDashboardHelper;
import org.beangle.emsapp.security.service.impl.ResourceServiceImpl;
import org.beangle.emsapp.security.service.impl.ServiceFlowServiceImpl;
...
public final class DefaultModule extends AbstractBindModule {
	...
	protected void doBinding() {
		...
		bind(SessioninfoLogAction.class, AuthorityAction.class, GroupAction.class, IndexAction.class,
				...
				RestrictMetaAction.class, UserAction.class, CaptchaAction.class,SubSystemAction.class,
				ServiceFlowAction.class).in(Scope.PROTOTYPE);
		...
		bind(ResourceServiceImpl.class).shortName();
		bind("serviceFlowService",ServiceFlowServiceImpl.class);
	}
