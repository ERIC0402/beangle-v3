...
public class DESDecrypt {
	...
	public static void main(String args[]) throws Exception {
		...
		String fKey = "07DB6454DA4F37C86F3462CAFA002E6B";/* 必需的密钥 */
		String sKey = "6B6BDF4328D069FFD14E8AA8EF0244FA";  
		String tKey = "9994C142B9100285CE20221BE59923B2";
		
		String data = "ABC码头matol-110ABC码头matol-110ABC码头matol-110ABC码头matol-110ABC码头matol-110ABC码头matol-110ABC码头matol-110";
		String strs = DESDecrypt.strEncode(data, fKey, sKey, tKey);
		String decs = DESDecrypt.strDecode(strs, fKey, sKey, tKey);
	...
	public byte[] decrypt(byte[] data, String key) throws Exception {
		Key k = DESEncrypt.getKey(desKey);
		Cipher cipher = Cipher.getInstance(DESEncrypt.ALGORITHM);
	...
	public static String strDecode(String data, String firstKey, String secondKey, String thirdKey) {
		int leng = data.length();
		String decStr = "";
		List<Object> firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
		int firstLength = 0, secondLength = 0, thirdLength = 0;
		if (firstKey != null && firstKey != "") {
			firstKeyBt = getKeyBytes(firstKey);
			firstLength = firstKeyBt.size();
	 ...
	 */
	public static List<Object> getKeyBytes(String key) {
