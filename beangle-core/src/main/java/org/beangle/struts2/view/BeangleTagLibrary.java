...
import org.beangle.struts2.view.component.ClassConfigTag;
...
import org.beangle.struts2.view.component.Img;
...
import org.beangle.struts2.view.component.Plupload;
...
public class BeangleTagLibrary extends AbstractTagLibrary {
	...
	public TagModel getClassConfig(){
		return get(ClassConfigTag.class);
	}
	...
	public TagModel getImg(){
		return get(Img.class);
	}
	
	public TagModel getPlupload(){
		return get(Plupload.class);
	}
