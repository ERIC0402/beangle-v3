...
/**
 * @author beangle
 * @version $Id: Select2.java May 2, 2011 10:09:28 AM beangle $
 */
public class Select2 extends UIBean {
	...
	private String style = "width:200px;height:200px";
	...
	protected void evaluateParams() {
		...
		if (null != myform) {
			...
			myform.addCheck(mySelectId, ".select2('"+mySelectId+"')");
//			if ("true".equals(required)) {
//				//myform.addCheck(mySelectId, "assert(bg.select.selectAll,'requireSelect')");
//				myform.addCheck(mySelectId, ".select2(true)");
//			} else {
//				//myform.addCheck(mySelectId, StrUtils.concat("assert(bg.select.selectAll(document.getElementById('", mySelectId, "'))||true)"));
//				myform.addCheck(mySelectId, ".select2(false)");
//			}
		}
