...
[@b.toolbar title="字典树" entityId=dictTree.id!0]bar.addBack();[/@]
[@b.form action="!save" title="字典树信息" theme="list"]
	...
	[@b.textfield label="代码" name="dictTree.dm" value="${dictTree.dm!}" maxlength="32" check="match('feihanzi')" comment="只能包含以下字符：a-z A-Z _"/]
