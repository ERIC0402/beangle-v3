...
<tr>
	<td>[@b.a href=link target="main"]<img height="48" style="margin-right:1em" alt="" width="48" src="${b.theme.iconurl(image!,48)}" />[/@]</td>
	<td style="vertical-align:middle">
		<div class="link">[@b.a href="${link}" target="main"]${name}[/@]</div>
...
<tr>
	<td width="40%" valign="top">
		<table id="management-links" style="padding-left: 2em;">
			[@menuitem image="setting.gif" link="dict-type" name="字典类型" remark="规划字典分类"/]
			[@menuitem image="user.gif" link="dict-data" name="字典数据" remark="创建字典数据"/]
			[#--
