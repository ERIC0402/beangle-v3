...
[@b.grid items=sessioninfos var="sessioninfo" refresh="${refreshInterval}" target="main"]
	[@b.gridbar]
	bar.addItem("过期",action.multi('invalidate','确定过期选择的会话吗?'),'${b.theme.iconurl('edit-delete.png')}');
	[/@]
	[@b.row]
		[@b.boxcol/]
