...
[#include "scope.ftl"/]
[#include "../status.ftl"/]
[@b.form name="resourceForm" id="resourceForm" action="!search" target="resourceList"]
[@b.grid items=resources var="resource" sortable="true" filterable="true"]
	...
	[@b.row]
		...
		[@b.col  width="20%" title="适用用户"][#list resource.categories as ca]${ca.title}[#if ca_has_next],[/#if][/#list][/@]
