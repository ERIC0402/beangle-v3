...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", base+"/static/metronic1.5.4/assets/css/themes/" + color + ".css");
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            ...
            el.block({
                message: '<img src="'+base+'/static/metronic1.5.4/assets/img/ajax-loading.gif" align="">',
