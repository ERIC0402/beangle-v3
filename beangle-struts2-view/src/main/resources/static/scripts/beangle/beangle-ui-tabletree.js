/** -----------------------table tree -----------------------------\
 ...
 |             introduce by beangle 2005-10-11                   |
 |-----------------------------------------------------------------|
 |Usage:                                                           |
...
var treeImagePath=bg.getContextPath()+"/static/themes/" + bg.uitheme + "/icons/16x16/tree/";
function toggleRows(elm) {
 ...
 for (var j = 0; j < rows.length; j++) {
   ...
   if (matchStart(s.id, thisID, matchDirectChildrenOnly)) {
     ...
     // chang 0 to defaultColumn by beangle for add a checkbox before tree sometime
...
/**
  added by beangle for collapse special depth
  2005-10-11 
*/
...
/**
  added by beangle for display special depth.
  2005-10-11
*/
