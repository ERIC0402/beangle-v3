...
jQuery.fn.highlight=function(j,n){if(j == null || j.length == 0)return;var h=jQuery.extend({hClass:null,hColor:"#C03",separator:" ",wrapper:"em",useDefaultStyle:true,needUnhighlight:false},n),l=typeof h.hClass=="string"&&h.hClass.length>0,o=$("<"+h.wrapper+"/>");if(l)o.addClass(h.hClass);else if(h.useDefaultStyle){o.css("color",h.hColor);"em"==h.wrapper&&o.css("font-style","normal")}var i=null;if(typeof j=="string")i=j.split(h.separator);else if(jQuery.isArray(j))i=j;for(l=0;l<i.length;l++)for(var y=i[l],p=i.length-1;p>l;p--)y==i[p]&&
