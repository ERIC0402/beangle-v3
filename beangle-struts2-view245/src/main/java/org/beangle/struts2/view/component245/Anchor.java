 ...
 */
package org.beangle.struts2.view.component245;
...
public class Anchor extends ClosingUIBean {
	...
	private String ajaxHistory = "true";
	...
	protected void evaluateParams() {
		...
		if (!isReserved()) {
			if (null == onclick) {
				if (null != target) {
					onclick = StrUtils.concat("return bg.Go(this,'", target, "',",ajaxHistory,")");
					target = null;
				} else {
					onclick = StrUtils.concat("return bg.Go(this,null,",ajaxHistory,")");
				}
			}
		}
	}
