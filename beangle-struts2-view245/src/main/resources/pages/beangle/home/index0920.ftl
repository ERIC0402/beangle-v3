...
<style type="text/css">
	#header_quicklink_item_2 div{float:left;}
</style>
<div id="Nav_bar">
	<div class="top_box">
		<div class="logo_box_home"><img src="${base}/static/themes/${b.theme.ui}/images/homePage/00index_03.png"></div>
		...
		<div id="items_header">
			<ul>
				...
				<li id="header_quicklink_item_2">
					...
					<div id="quicklink_3">
						<div class="div_box"><a href="${base}/help.doc" target="_blank">帮 助</a></div>
					</div>
					<div id="quicklink_5">
	...
	<div id="MainBody" class="bg1">
		...
		<div id="tool_bar">
			<div id="tab_title_box_1" style="width:1000px;">
				...
				[#if menu.entry??]
				[#assign href]${menu.entry}[/#assign]
				[#elseif menu.id??]
				[#assign href]!submenus?menu.id=${menu.id}[/#assign]
				[/#if]
				[#return href/]
				[/#function]
				...
				[#list menus?if_exists as module]
					[#if module_index==0]
					[@b.a class="a_now" href="${menuHref(module)}" target="main" ]
						<span>[@i18nNameTitle module/]</span>
					[/@]
					[#else]
					[@b.a href="${menuHref(module)}" target="main" ]
						<span>[@i18nNameTitle module/]</span>
					[/@]
					[/#if]
				[/#list]
		...
		[#if menus?size gt 0]
		[@b.div id="main" class="main" href="${menuHref((menus?first)!)}"/]
		[/#if]
	</div>
</div>

<!-- 底部版权 -->
<div id="BottomBg">111${(systemVersion.vendor)!'Copyright &copy; 2012 BEANGLE Inc. All Rights Reserved. BEANGLE 版权所有'}</div>
