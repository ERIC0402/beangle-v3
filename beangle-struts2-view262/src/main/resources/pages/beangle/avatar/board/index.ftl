...
[#include "../nav.ftl"/]
	...
	<table align="center" id="avatarPanel" width="90%">
		...
		<tr>
		  ...
		  <td style="padding:5px" align="center">
			  ...
			  [#--
			  <a class="avatar_img_a" href="${b.url('board!info')}?user.name=${name}" title="点击查看照片详情">${name}</a>
			  --]
			  [@b.a href="board!info?user.name=${name}" title="点击查看照片详情"]${name}[/@]
		  </td>
		  [/#list]
	   </tr>
	   [/#list]
	...
	<script type="text/javascript">
		//$(".avatar_img_a").colorbox();
		//$(".avatar_img_a").colorbox({iframe:true, width:"50%"});
	</script>
[@b.foot/]