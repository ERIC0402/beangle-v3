...
[@b.gridbar title="菜单列表"]
	...
	bar.addItem("打印","preview()",'${b.theme.iconurl('actions/print.png')}');
	bar.addItem("导出XML",action.method('exportXML',null,null,false));
	bar.addItem("导入XML",action.method('importXML',null,null,true));
