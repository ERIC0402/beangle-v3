...
[@b.grid items=users var="user"]
	...
	[@b.row]
		...
		[@b.col property="updatedAt" title="common.updatedAt" width="11%"]${user.updatedAt?string("yyyy-MM-dd")}[/@]
		[@b.col property="enabled" title="common.status" width="8%"][@enableInfo user.enabled/][/@]
	[/@]
[/@]
[@b.foot/]