 ...
 * 是否搜索内容 regex = new RegExp(searchText.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), 'i');
 * 更新数据时不清空输入内容 //      this.show_search_field_default();
 * 更新数据时并搜索内容：   Chosen.prototype.results_build    this.winnow_results();
 */
(function() {
  /*
  ...
  */
  ...
  Chosen = (function() {
    function Chosen(elmn) {
      ...
      this.default_text_default = this.form_field.multiple ? "请选择多个选项" : "请选择一个选项";
      this.set_up_html();
